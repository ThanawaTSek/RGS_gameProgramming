...
public class Builder : MonoBehaviour
{
    ...
    private void CheckClickOnGround()
    {
        ...
        {
            bool canBuild = ghostBuilding.GetComponentInChildren<FindBuildingSite>().CanBuild;
    ...
    } // เปลี่ยน State เป็น BuildProgress (ตอกโป๊กๆ)
